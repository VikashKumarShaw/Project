	...
	<div class="row">
				<div class="col-xs-12 col-sm-10 col-md-10 col-sm-offset-2 col-md-offset-3">
					...
					<form role="form">
						...
						<div class="form-group" action="Home.jsp">
						CREDIT SCORE <br/><br/>
		<input type="text" name="rep" id="AsID" class="form-control input-lg" placeholder="Credit Score" tabindex="1" ><br/>
		
		</div>
						
							<input type="submit" value="Home" class="btn btn-primary btn-block btn-lg color-b" tabindex="7">
						</div>
						<hr/>
