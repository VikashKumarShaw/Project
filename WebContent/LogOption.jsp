...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-md fixed-top navbar-dark  bg-dark">
	  <a class="navbar-brand" href="#">Academy Portal</a>
				...
				<div class="col-sm-6">
					<div class="card">
					  <div class="card-body">
						...
						<a href="Login.jsp" class="btn btn-primary btn-sm color-b">Click To Sign In</a>
				...
				<div class="col-sm-6">
					<div class="card">
					  <div class="card-body">
						...
						<a href="SignUp.jsp" class="btn btn-primary btn-sm color-b">Click to Register</a>
