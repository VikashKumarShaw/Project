		...
		<div class="row">
				...
				<div class="card-body" style="background-color:#f5f5f5;">
					...
					<form role="form" action="Home.jsp">
						...
						</br><input type="text" name="name" id="Name" class="form-control input-lg" placeholder="Weekly Project" tabindex="1" ><br/>
							<font size="4">BHS Report </font> &nbsp;
							<input type="radio" name="gender" value="male"> Yes &nbsp;&nbsp;
							<input type="radio" name="gender" value="female"> No<br/><br/>
						<input type="text" name="mock" id="Mock" class="form-control input-lg" placeholder="Mock Test" tabindex="1" ><br/>
						<font size="4">Innovations </font>&nbsp;
							<input type="radio" name="gender" value="male"> Yes &nbsp;&nbsp;
							<input type="radio" name="gender" value="female"> No<br/><br/>
								<font size="4">Completed </font> &nbsp;
