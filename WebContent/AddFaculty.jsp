				...
				<div class="col-xs-12 col-sm-10 col-md-10 col-sm-offset-2 col-md-offset-3">
					<form role="form" action="Home.jsp">
						...
						<div class="form-group">
							...
							<input type="text" name="name" id="Name" class="form-control input-lg" placeholder="Name" tabindex="1" required><br/>
							<input type="text" name="qualification" id="qualification" class="form-control input-lg" placeholder="Qualification" tabindex="3" required></br>
							<input type="text" name="skill" id="skill" class="form-control input-lg" placeholder="Skill" tabindex="3" required></br>
							<font size="4">Certification </font></br></br>
