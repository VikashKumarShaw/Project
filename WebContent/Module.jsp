				...
				<div class="card-body" style="background-color:#f5f5f5;">
					...
					<form role="form" action="Home.jsp">
						...
						<div class="form-group">
							...
							<input type="text" name="name" id="Name" class="form-control input-lg" placeholder="Module Name" tabindex="1" required><br/>
							<input type="text" name="id" id="id" class="form-control input-lg" placeholder="Module ID" tabindex="3" required></br>
